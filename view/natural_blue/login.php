				...
				<div class="panel-body">
					...
					<div class="row">
						<div class="col-xs-12 bg-info footer">
							<span class="col-xs-6">
								IP: <text class="footer-text">127.0.0.1</text><br />
								Mac: <text class="footer-text">01:02:03:04:05:06</text>
							</span>
							<span class="col-xs-6">
								Language:<br />
								<abbr title="You're in English page" class="initialism">English</abbr> /  <a href="$(link-login-only)?dst=$(link-orig-esc)&target=id">Indonesia</a>
							</span>
